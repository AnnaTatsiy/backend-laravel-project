...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        })->timezone('Europe/Moscow')->dailyAt('08:00'); // ежедневно в 15:00

        $schedule->call(function (){
            GroupWorkoutController:: preparationAdd();
        })->timezone('Europe/Moscow')->dailyAt('08:00'); // ежедневно в 09:00

        $schedule->call(function (){
            SignUpPersonalWorkoutController:: addSignUpPersonalWorkoutsForAllCoaches();
        })->timezone('Europe/Moscow')->dailyAt('09:00'); // ежедневно в 09:00
        ...
        })->timezone('Europe/Moscow')->dailyAt('10:00'); // ежедневно в 10:00
